...
if __name__ == "__main__":
    ...
    for index, row in data_info_df.iterrows():
        ...
        if os.path.exists(os.path.join(r'H:\other_files\Heart_OpenDataset\OpenDataset\Testing',
                                       row["External code"])):
    ...
    for index, row in data_info_df.iterrows():
        ...
        # )
        img_example = os.path.join(
            r'H:\other_files\Heart_OpenDataset\OpenDataset\Testing',
            img_example, "{}_sa.nii.gz".format(img_example)
        )
    ...
    data_info_df.to_csv(r"H:\other_files\Heart_OpenDataset\OpenDataset\uitls\data/test.csv", index=False)
