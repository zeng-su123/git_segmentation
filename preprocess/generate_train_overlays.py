...
def get_args():
    ...
    parser.add_argument("--save_dir", type=str, default=r"H:\other_files\Heart_OpenDataset\overlays", help="Where to save overlays")
...
if __name__ == "__main__":
    ...
    data_info_df = pd.read_csv(r"G:\fifth_heart\MnMsCardiac-master\utils\data\train.csv")
