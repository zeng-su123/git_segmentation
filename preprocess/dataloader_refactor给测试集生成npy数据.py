...
df = pd.read_csv(r"H:\other_files\Heart_OpenDataset\OpenDataset\uitls\data\train_2.csv")
...
for index, row in df.iterrows():
    ...
    if row["Labeled"]:
        ...
        new_mask_dir_path = os.path.join(
            r'H:\other_files\Heart_OpenDataset\OpenDataset\Training', "Training-corrected-contours", "Labeled_npy",
            external_code,
        )
        ...
        new_img_dir_path = os.path.join(
            r'H:\other_files\Heart_OpenDataset\OpenDataset\Training', "Training-corrected", "Labeled_npy",
            external_code,
        )
