...
# val_dataset = dataset_selector("test", val_aug, [], args)
...
val_loader = DataLoader(val_dataset, batch_size=1, shuffle=False, drop_last=False)        # zsx注释掉原本的，有用
# val_loader = DataLoader(train_dataset, batch_size=1, shuffle=False, drop_last=False)
...
# save_path zsx
save_path = r'K:\train_folder\correct-eval'
